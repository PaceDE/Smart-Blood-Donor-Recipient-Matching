...
export default function Home() {
  ...
  const colors = ['#EF4444', '#F97316', '#EAB308', '#84CC16', '#22C55E', '#14B8A6', '#3B82F6', '#8B5CF6'];
  const darkColors = ['#cc3737', '#d87014', '#c9a807', '#6ca20f', '#1fa04f', '#11958f', '#3570d1', '#7847d6'];

  const reqValues = Object.values(bloodReqDistribution) || {}
  const donValues = Object.values(bloodDonateDistribution) || {}
        ...
        <div className='bg-white border border-gray-200 p-5 rounded-lg '>
          <div>
            ...
            <div className="mt-5 w-[280px] h-[280px] md:w-[450px] md:h-[450px] mx-auto">
              <DoughnutChart labels={labels} values={values} colors={colors} darkColors={darkColors} label="Blood Type Count" />
            </div>
